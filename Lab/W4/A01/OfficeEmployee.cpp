...
OfficeEmployee::OfficeEmployee(const std::string& id, const std::string& name, const Date& date, const std::string& addr, int days)
    : Employee(id, name, date, addr), workingDays(days) {}

OfficeEmployee::OfficeEmployee(const OfficeEmployee& other)
    : Employee(other), workingDays(other.workingDays) {}

OfficeEmployee::OfficeEmployee(const std::string& id, const Date& date, int days)
    : Employee(id, date), workingDays(days) {}
