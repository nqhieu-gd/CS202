...
Worker::Worker(const std::string& id, const std::string& name, const Date& date, const std::string& addr, int items)
    : Employee(id, name, date, addr), producedItems(items) {}

Worker::Worker(const Worker& other)
    : Employee(other), producedItems(other.producedItems) {}

Worker::Worker(const std::string& id, const Date& date, int items)
    : Employee(id, date), producedItems(items) {}
